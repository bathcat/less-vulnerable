...
public static class ServiceCollectionExtensions
{
    ...
    public static void ConfigurePersistance(this IServiceCollection services, string connectionString)
    {
        services.ConfigureAppDbContext(connectionString);
        services.ConfigureIdentityDbContext(connectionString);
    }

    public static void ConfigureAppDbContext(this IServiceCollection services, string connectionString) => services.AddDbContext<AppDbContext>(
           options => options.UseSqlServer(connectionString)
       );

    public static void ConfigureIdentityDbContext(this IServiceCollection services, string connectionString) => services.AddDbContext<IdentityDbContext>(
          options => options.UseSqlServer(connectionString)
       );

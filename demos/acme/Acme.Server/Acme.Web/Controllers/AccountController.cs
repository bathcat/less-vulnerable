...
public class AccountController : Controller
{
   ...
   private Task<User> GetCurrentUserAsync() => this._userManager.GetUserAsync(this.HttpContext.User);

   private IActionResult RedirectToLocal(string returnUrl) => this.Url.IsLocalUrl(returnUrl) ? this.Redirect(returnUrl) : this.RedirectToAction(nameof(HomeController.Index), "Home");
